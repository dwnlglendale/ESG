...
namespace CarbonFootprint1.Migrations
{
    ...
    [Migration("20230210085954_userAndBranchSetup")]
    partial class userAndBranchSetup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarbonFootprint1.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("UserBranchBranchID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarbonFootprint1.Models.ApplicationUser", b =>
                {
                    b.HasOne("CarbonFootprint1.Models.Branches", "UserBranch")
                        .WithMany()
                        .HasForeignKey("UserBranchBranchID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
